...
const DONO = "299739172791648267"; // Coloque seu ID
...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        try {
           ...
           client.user.setPresence({ activities: [{ name: `${desc}` }], status: `${status}` });
            ...
            return console.log(`Ops ${interaction.user}, algo deu errado ao executar este comando. ${error}`)
        }
    }
}